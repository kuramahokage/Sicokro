<?php
// app/models/PembayaranModel.php (copy)
class PembayaranModel {
    ...
    public function listBySekolah(int $sekolah_id, int $limit = 100) {
        $stmt = $this->pdo->prepare("SELECT p.*, t.kode_tagihan, t.deskripsi as tagihan_deskripsi FROM pembayaran p LEFT JOIN tagihan t ON p.tagihan_id = t.id WHERE p.sekolah_id = :sek LIMIT :limit");
