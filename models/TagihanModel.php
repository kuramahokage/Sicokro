<?php
// REMOVED DUPLICATE: canonical model moved to app/models/TagihanModel.php
// This file kept for backward-compatibility marker. You can safely delete it.
class TagihanModel {
    private $pdo;
    ...
    // Get tagihan list by sekolah and periode (YYYY-MM) - filters by tgl_dibuat
